...
const addVendor = async (req, res) => {
  ...
  try {
    const { img, coverImg, name, shopname, address, contact, openCloseHours, menu } = req.body;
    ...
    await Vendor.create({ img, coverImg, name, shopname, address, contact, openCloseHours, menu });
